...
const Concerts = () => {
    ...
    >
      <div className="flex items-start gap-6">
        ...
        <div className="flex-grow">
          <h3 className="text-xl font-normal text-gray-900 mb-2">{concert.venue}</h3>
          ...
          <div className="flex gap-3">
            {concert.ticketUrl && (
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-muse-red text-white rounded-lg
                         hover:bg-red-700 transition-all duration-300 text-sm font-medium"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {concert.moreInfoUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 border border-muse-red text-muse-red 
                         rounded-lg hover:bg-muse-red hover:text-white transition-all duration-300 
                         text-sm font-medium"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="concerts-section bg-gradient-to-b from-gray-50 to-white">
      <div className="container-custom section-padding">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="heading-2 text-muse-red mb-4">Concerts</h2>
        ...
        {upcomingConcerts.length > 0 && (
          <div className="mb-12">
            <h3 className="text-2xl font-normal text-gray-800 mb-6 flex items-center gap-2">
        ...
        {pastConcerts.length > 0 && (
          <div>
            <h3 className="text-2xl font-normal text-gray-800 mb-6">Past Concerts</h3>
