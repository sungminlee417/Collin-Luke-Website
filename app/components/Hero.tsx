...
const Hero = () => {
  return (
    <section className="hero-section relative min-h-screen flex items-center justify-center md:justify-start overflow-hidden">
      ...
      <motion.div
        className="relative z-10 text-center md:text-left px-4 will-change-transform md:ml-24 lg:ml-32"
      ...
      >
        ...
        >
          ...
          <Image
            ...
            width={400}
            height={200}
            className="max-w-[90vw] max-h-[40vh] w-auto h-auto object-contain mx-auto md:mx-0 drop-shadow-2xl"
            priority
          />
        </motion.div>
