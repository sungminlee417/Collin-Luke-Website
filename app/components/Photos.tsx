...
const Photos = () => {
  ...
  return (
    <>
      <section className="photos-section bg-gradient-to-b from-gray-50 to-white">
        <div className="container-custom section-padding">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="heading-2 text-muse-red mb-4">Gallery</h2>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
            ...
            >
              <div className="sticky top-8">
                <h3 className="text-xl font-normal text-gray-900 mb-6">Follow Us on Instagram</h3>
                  ...
                  <div className="min-h-[400px] flex flex-col">
                    ...
                    <div className="p-4 bg-white border-t border-gray-100">
                      <a
                        ...
                        className="flex items-center justify-center gap-2 text-muse-red hover:text-red-700 
