      ...
      <section className="photos-section bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="container-custom section-padding px-2 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start min-w-0">
                ...
                >
                  {images.map((image, index) => (
                    <SwiperSlide key={index}>
                      <motion.div
                        className="relative aspect-[4/3] cursor-pointer group overflow-hidden rounded-xl w-full max-w-full"
            ...
            <motion.div
              className="xl:col-span-1 min-w-0"
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
            >
              <div className="sticky top-8">
                <h3 className="text-xl font-normal text-gray-900 dark:text-gray-100 mb-6">
                  Follow Us on Instagram
                </h3>
                <div className="rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-700 w-full max-w-full">
                  <div className="min-h-[400px] flex flex-col">
                    <div className="instagram-embed-container w-full max-w-full overflow-hidden">
